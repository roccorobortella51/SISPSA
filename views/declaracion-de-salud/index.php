...
$this->title = 'Declaracion De Saluds';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="declaracion-de-salud-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Declaracion De Salud', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, DeclaracionDeSalud $model, $key, $index, $column) {
