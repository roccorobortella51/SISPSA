                        ...
                        <div>
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mr-3">
                                    <i class="fas fa-chart-pie me-2 ms-primary mr-3" style="font-size: 1.9rem;"></i>
                                    <h2 class="fw-bold mb-0 text-muted" style="font-size: 1.8rem !important;">
                                        Resumen y Distribución de Pagos por Clínica
                                    </h2>
                                </div>
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="d-flex align-items-center mr-3">
                                        <i class="far fa-calendar-alt me-2 ms-primary mr-4" style="font-size: 1.6rem;"></i>
                                        <span class="ms-body-lg fw-bold" style="font-size: 1.5rem !important;">
                                            Para el período: <?= $startDate ?>
                    ...
                    <div class="d-flex flex-column align-items-lg-end gap-2">
                        ...
                        <div class="text-center text-lg-end w-100">
                            <div class="d-inline-block px-3 py-2 rounded-3 shadow-sm"
                                style="background: white; border-left: 4px solid #107c10; min-width: 250px;">
                                <div class="ms-body-sm text-muted mb-1" style="font-size: 1.1rem !important;">
                                    <i class="fas fa-database me-2"></i>Registros Totales
                                </div>
                        ...
                        <div class="text-center text-lg-end w-100">
                            <div class="d-inline-block px-3 py-2 rounded-3 shadow-sm"
                                style="background: white; border-left: 4px solid #0078d4; min-width: 250px;">
                                <div class="ms-body-sm text-muted mb-1" style="font-size: 1.1rem !important;">
                                    <i class="fas fa-hospital me-2 ms-primary"></i>Clínicas Analizadas
                                </div>
                                <div class="display-6 fw-bold ms-primary" style="font-size: 2.2rem !important;">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex justify-content-lg-end gap-2 flex-wrap">
                                <a href="#" id="btn-print-pdf" class="ms-btn ms-btn-danger px-3 py-2 shadow mr-4"
